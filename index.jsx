  ...
  createRoutesFromElements(
    <Route path="/" element={<Layout />}>
      ...
      <Route path="host" element={<HostLayout />}>
        ...
        <Route path="hostVans" element={<HostVans />} errorElement={<Error />} loader={hostVansLoader} />
        <Route path="hostVans/:id" element={<HostVanDetail />} errorElement={<Error />} loader={hostVanDetailLoader}>
